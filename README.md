...
**🔗 Live demo:** [try it on Hugging Face Spaces](https://huggingface.co/spaces/LaelaZ/rlhf-pairwise-rater). Rate a pair and watch the self-consistency check and Cohen's κ update live.
...
1. **My own consistency drift.** After 20 cases I'd forget exactly how I was weighting "harmlessness" vs "helpfulness", and my ratings would slowly drift, which is why recording the per-axis scores forces explicitness.
